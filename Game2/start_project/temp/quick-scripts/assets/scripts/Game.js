...
cc._RF.push(module, '1f7bcRS7GZJiKzfsoEYu6LO', 'Game', __filename);
// scripts/Game.js
...
cc.Class({
    ...
    gainScore: function gainScore(index) {
        if (index === 1) {
            this.score += 1;
            this.scoreDisplay.string = 'Score: ' + this.score;
        } else if (index === 2) {
            this.score2 += 1;
            this.scoresDisplay.string = 'Score: ' + this.score2;
        }
        // this.score += 1;
